...
% bar data
means = [kfold_means(1:6); block_means(1:6); block2_means(1:6)]';
...
errors = [kfold_stds(1:6); block_stds(1:6); block2_stds(1:6)]';
for i = 1:nbars
