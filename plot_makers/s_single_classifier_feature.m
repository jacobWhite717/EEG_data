function s_single_classifier_feature(data_folder, subject_range, classifier, feature_cat, c_disp, save_flag)

    [svm_k_m, svm_k_s, svm_b_m, svm_b_s] = get_clasifier_feature_data(data_folder, subject_range, classifier, feature_cat);
    ...
    if save_flag
        mkdir("results/plots/single_classifier_feature")
        plot_savename = char(sprintf("results/plots/single_classifier_feature/s %s %i class.png", feature_cat, c_disp));
