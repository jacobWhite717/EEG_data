...
function r_single_classifier_feature(data_folder, subject_range, classifier, feature_cat, c_disp, save_flag)

    [svm_k_m, svm_k_s, svm_b_m, svm_b_s, svm_b2_m, svm_b2_s] = get_rand_clasifier_feature_data(data_folder, subject_range, classifier, feature_cat);
